...
This includes that the machine goes beyond mere text recognition but can link text to meaning and assess logic. The algorithms behind deep learning use so-called deep neural nets, which can also combine
text recognition with translations into other languages. Companies experimenting with such technology include the startup omni:us. Challenges and error margins...

One concern in the training of deep learning algorithms is the large amount of data needed. Some companies train on personal documents that include customer information etc.
